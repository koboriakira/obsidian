...
ai-captured.md 生成後、Discordに今日の一日を表現した文章を返信する。

### フォーマット指針

- ルーティン（朝のルーティン・夜のルーティン・送迎・入浴・食事等）は記述しない
- **プロジェクト・Areaにおける進展を中心に表現する**
  - どのプロジェクト/Areaで何が前進したか
  - 意思決定・完了・新しい発見など
- 自然な文章で書く（箇条書きの羅列にしない）
- 200〜350字程度
- 末尾に「補足したい時間帯や出来事があれば教えてください」を添える
